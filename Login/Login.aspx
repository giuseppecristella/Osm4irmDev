    ...
    <form id="LoginPage" runat="server">
        ...
        <div class="content">
            <div class="form-vertical login-form" action="index.html">
                <h3 class="form-title">Area Riservata</h3>
                    ...
                    <LayoutTemplate>
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <asp:RequiredFieldValidator ForeColor="white" CssClass="label label-important" ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                        ...
                        <div class="form-actions">
                            <a class="btn green" target="_blank" href="https://www.artera.it/webmail">Accedi alla WebMail</a>
            ...
            <div class="alert alert-info">
                Per accedere alla WebMail non è necessario compilare i campi utente/password.
            </div>
        </div>
        <div class="copyright">
            2013 &copy; Osmairm.
